// src/main.js
/**
 * Main entry point for IntelligentCryptoEngine application
 */
...
class IntelligentCryptoEngine {
    /**
     * Create a new IntelligentCryptoEngine instance
...
module.exports = IntelligentCryptoEngine;
...
if (require.main === module) {
    ...
    const app = new IntelligentCryptoEngine({
        input: args.input,
        output: args.output,
