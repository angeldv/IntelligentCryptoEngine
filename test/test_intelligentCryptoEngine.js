// test/test_intelligentCryptoEngine.js
/**
 * Unit tests for IntelligentCryptoEngine
 */

const assert = require('assert');
const { IntelligentCryptoEngine } = require('../src/main');
const fs = require('fs').promises;
const path = require('path');

describe('IntelligentCryptoEngine', function() {
    this.timeout(5000);
